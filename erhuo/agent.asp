...
<body>
    ...
    <div class="release_main w">
        <div class="release_title">代销物品信息填写</div>
        ...
        <form action="./saveAgentInfo.asp" method="POST" target="_self">
            ...
            <table>
                ...
                <tr>
                    <td><label for="money1">底&emsp;&emsp;价:</label></td>
                ...
                <tr>
                    <td><label for="place">取货地址:</label></td>
