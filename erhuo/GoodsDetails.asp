...
<body>
    ...
    <div class="detials_main w">
        <div class="master clearfix">
            ...
            <form style="display: block; float: left; margin-left: 20px;" action="./delGoods.asp" method="POST" target="_self">
                <button style="border: none; height: 60px; line-height: 60px; background-color: #393d42; font-size: 18px; color: #fee7b8; cursor: pointer;">删除商品</button>
