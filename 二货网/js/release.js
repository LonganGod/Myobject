...
// 取消图片
var close = document.querySelector('.good_imgs .close');

close.onclick = function () {
    var img = close.parentNode.querySelector('img');
    var add = close.parentNode.querySelector('i');
